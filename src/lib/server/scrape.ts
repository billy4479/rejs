...
const selectors = {
  ...
  username:
    "div.form-group:nth-child(2) > div:nth-child(2) > input:nth-child(2)",
...
export async function scrape(
  ...
  await page.goto(
    "https://scuoladigitale.axioscloud.it/Pages/SD/SD_Login.aspx"
  );
